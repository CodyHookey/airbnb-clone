...
users = User.create([
  { username: 'Tommy', email: 'tommy@test.com', password: 'password', property_owner: true },
  { username: 'Bobby', email: 'bobby@test.com', password: 'password', property_owner: true },
  { username: 'Sarah', email: 'sarah@test.com', password: 'password', property_owner: true },
  { username: 'Lilly', email: 'lilly@test.com', password: 'password', property_owner: true },
  { username: 'Jimmy', email: 'jimmy@test.com', password: 'password', property_owner: true },
  { username: 'Cammy', email: 'cammy@test.com', password: 'password', property_owner: true },
])
